...
declare module ng.resource {
    ...
    interface IResourceService {
        ...
        <T extends IResource<any>, U extends IResourceClass<any>>(url: string, paramDefaults?: any,
                                                              /** example:  {update: { method: 'PUT' }, delete: deleteDescriptor }
                                                               where deleteDescriptor : IActionDescriptor */
            actionDescriptors?: any): U;
        <T extends IResource<any>>(url: string, paramDefaults?: any,
                                 /** example:  {update: { method: 'PUT' }, delete: deleteDescriptor }
                                  where deleteDescriptor : IActionDescriptor */
    ...
    interface IResourceClass<T extends IResource<any>> {
        get(): T;
    ...
    interface IResource<T extends IResource<any>> {
        $get(): T;
        $get(dataOrParams: any): T;
        $get(dataOrParams: any, success: Function): T;
        $get(success: Function, error?: Function): T;
    ...
    interface IResourceServiceFactoryFunction<T extends IResource<any>> {
